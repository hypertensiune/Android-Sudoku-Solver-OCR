...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    /** https://gist.github.com/heaversm/63e8036af6a124aecf3b26898bd2a0ad#file-opencv-portait-camera-android-java **/
    ...
    **/
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            // rotate canvas 90 degrees and recalculate scale
            canvas.rotate(90f, canvas.getWidth() / 2, canvas.getHeight() / 2);
            float mScale1 = (float) canvas.getHeight() / (float) (mCacheBitmap.getWidth()) - 0.5f;
            float mScale2 = (float) canvas.getWidth() / (float) (mCacheBitmap.getHeight());
            //float mScale1 = mScale;
            ...
            if (canvas != null) {
                ...
                if (mScale1 != 0) {
                    canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
                         ...
                         (int)((canvas.getWidth() - mScale2*mCacheBitmap.getWidth()) / 2 + mScale2*mCacheBitmap.getWidth()),
                         (int)((canvas.getHeight() - mScale1*mCacheBitmap.getHeight()) / 2 + mScale1*mCacheBitmap.getHeight())), null);
                } else {
                     canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
                         new Rect((canvas.getWidth() - mCacheBitmap.getWidth()) / 2,
                         (canvas.getHeight() - mCacheBitmap.getHeight()) / 2,
